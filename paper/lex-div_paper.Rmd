...
REFINE definition of LD vocabulary size and the extent to which speakers make fullest use of available vocabulary knowledge [@laufer1995].
Halliday [@halliday1985] concludes the complexity of written language is lexical and that of spoken language is grammatical. Halliday relates grammar to semantics with an empahsis on how various linguistic items function in any text and connect to building meanings. After all speech production at the early stage of human species functions as the primary medium for communicating our needs.
