...
mtld_data <- read_feather("/Users/Yawen/Desktop/
                          lexical diversity/trial5_ldp/mtld_data.feather")
mattr_data <- read_feather("/Users/Yawen/Desktop/
                           lexical diversity/trial5_ldp/mattr_data.feather")
vocd_data <- read_feather("/Users/Yawen/Desktop/
                          lexical diversity/trial5_ldp/vocd_data.feather")
ttr_data <- read_feather("/Users/Yawen/Desktop/
                         lexical diversity/trial5_ldp/ttr_data.feather")
session_age <- read_feather("/Users/Yawen/Desktop/
                            lexical diversity/trial5_ldp/session_age.feather")
...
ttr_data <- read_feather("/Users/Yawen/Desktop/
                         lexical diversity/trial6_childes/ttr_data.feather")
vocd_data <- read_feather("/Users/Yawen/Desktop/
                          lexical diversity/trial6_childes/vocd_data.feather")

childes_all <- mtld_data %>%
  left_join(mattr_data) %>%
  left_join(vocd_data) %>%
  left_join(ttr_data)

write_feather(childes_all,"/Users/Yawen/Desktop/
              lexical diversity/trial5_ldp/childes_all.feather")
```

#### Compare by Plotting Growth Curve
```{r, message=F, warning=F}
childes_all <- read_feather("/Users/Yawen/Desktop/
                            lexical diversity/trial5_ldp/childes_all.feather") %>%
  filter(age >=14 & age <=58) # align age range with that of LDP
ldp_all <- read_feather("/Users/Yawen/Desktop/
                        lexical diversity/trial5_ldp/ldp_all.feather")
